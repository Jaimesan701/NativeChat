...
public abstract class NCRoomManager {
	...
	public abstract void sendExitMessage(String u);
	public abstract void sendEnterMessage(String u);
	public abstract int sendPrivate(String mensaje, String emisor, String receiver);
