...
public class Directory {
	...
	public static void main(String[] args) {
		...
		DirectoryThread dt;
		try {
			// Hilo que ejecuta el servidor de directorio.
			// Se le pasa el nombre, el puerto y la probabilidad de perder un paquete
			dt = new DirectoryThread("Directory", DIRECTORY_PORT, datagramCorruptionProbability);	// el servidor se queda escuchando en ese puerto
			dt.start();
